...
CREATE TABLE IF NOT EXISTS `provinces` (
  ...
  `province_name_uppercase` varchar(255) NOT NULL,
  `province_slug` varchar(255) NOT NULL,
  PRIMARY KEY (`id_province`),
  KEY `fk_provinces_states1_idx` (`state_id`)
...
INSERT INTO `provinces` (`id_province`, `state_id`, `code`, `province_name`, `province_name_uppercase`, `province_slug`) VALUES
(1, 22, '01', 'Ain', 'AIN', 'ain'),
